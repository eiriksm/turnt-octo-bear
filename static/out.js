...
var Header = React.createClass({displayName: 'Header',
  render: function() {
    return (
      React.DOM.div(null, 
        React.DOM.input({id: "drawer-toggle-left", type: "checkbox", className: "drawer-toggle", name: "drawer-toggle"}), 
        React.DOM.label({htmlFor: "drawer-toggle-left", className: "drawer-toggle-label"}), 
        React.DOM.header(null, "TURNT OCTO BEAR"), 
        React.DOM.nav({className: "drawer left"}, 
...
var UsersList = React.createClass({displayName: 'UsersList',
  render: function() {
    ...
    var renderUser = function(user) {
      ...
      return React.DOM.li({key: user.id}, React.DOM.a(null, " ",  user.name, " "))
    };
    return (
        React.DOM.ul(null,  list.map(renderUser) )
    );
  }
});
...
var ChangeNameForm = React.createClass({displayName: 'ChangeNameForm',
  ...
  render: function() {
    return(
      React.DOM.div({className: "change_name_form"}, 
        React.DOM.form({onSubmit: this.handleSubmit}, 
          React.DOM.input({onChange: this.onKey, value: this.state.newName})
        )
      )
    );
  }
...
},{"../src/errorcodes":152,"../src/models/message":153,"./jsx/message":154,"./jsx/messageform":155,"./jsx/messagelist":156,"primus":157,"react":151}],2:[function(require,module,exports){
...
},{"../helpers/colors":5}],4:[function(require,module,exports){
var getColor = require('../helpers/colors');
...
},{"../helpers/colors":5}],5:[function(require,module,exports){
...
},{"./drawers/circles":3,"./drawers/lines":4,"seed-random":7}],7:[function(require,module,exports){
(function (global){
'use strict';
    ...
    return(
      React.DOM.div({className: "message"}, 
        React.DOM.div({className: "meta"}, 
          React.DOM.strong(null,  this.props.name, " "), "(", React.DOM.em(null,  date.getHours() + ':' + date.getMinutes()), "):"
        ), 
        React.DOM.div({dangerouslySetInnerHTML: {__html: tmp.innerHTML}}), 
...
},{"msg2svg":6,"react":151}],155:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
var MessageModel = require('../../src/models/message');
...
var MessageForm = React.createClass({displayName: 'MessageForm',
  ...
  render: function() {
    return(
      React.DOM.div({className: "message-form"}, 
        React.DOM.form({onSubmit: this.handleSubmit}, 
          React.DOM.input({onChange: this.changeHandler, value: this.state.text, placeholder: "Enter message"})
        )
      )
    );
  }
...
},{"../../src/models/message":153,"react":151}],156:[function(require,module,exports){
/** @jsx React.DOM */
var React = require('react');
var Message;
